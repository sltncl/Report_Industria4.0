...
#' 
#' SCRIPT: Lo script che si sta descrivendo consente di generare un grafico a colonne che illustra l'andamento degli investimenti 
#' in ricerca e sviluppo effettuati dalle aziende italiane che presentano i livelli di investimento più elevati.
#' 
#' --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
