...
#' 
#' SCRIPT: Questo script serve per realizzare un grafico a linea sull'andamento degli investimenti
#' in ricerca e sviluppo da parte dei paesi europei che investono di più
#' 
#' --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
...
# Per ogni anno si sommano tutti gli investimenti effettuati da ogni paese e si modificano eventuali valori che non permettono il confronto dei dataset
# Dal 2016 al 2012 i Paesi Bassi sono denominati "The Netherlands", dal 2022 al 2017 "Netherlands", quindi abbiamo sostituito il valore "The Netherlands" con "Netherlands" in modo tale da poter confrontare gli investimenti negli anni
# Inoltre, nel 2013 la colonna relativa agli investimenti in R&D non è di tipo numerico, quindi tutti i valori della colonna vengono modificati in numerici
