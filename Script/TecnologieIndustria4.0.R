...
#' 
#' SCRIPT: Questo script serve per realizzare dei grafici a barre sulla percentuale di utilizzo
...
# I dataset vengono filtrati selezionando le colonne relative al paese, all'anno e alla percentuale di utilizzo
# La sigla di ogni paese viene sostituita dal nome per intero e le righe vuote vengono rimosse
